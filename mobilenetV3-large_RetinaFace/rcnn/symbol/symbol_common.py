...
def get_sym_conv(data, sym):
    ...
    for i in range(count):
      ...
      print(i,' stride: ',stride, ':',name, shape)
...
def get_sym_train(sym):
    ...
    if config.CONTINUE:
        ...
        #conv_fpn_feat[4] = all_layers['rf_c1_det_concat_relu_output']
        #conv_fpn_feat[8] = all_layers['rf_c2_det_concat_relu_output']
        #conv_fpn_feat[16] = all_layers['rf_c3_det_concat_relu_output']
