...
def get_gt_boxes(gt_dir):
    ...
    facebox_list = gt_mat['face_bbx_list'][:5]
    event_list = gt_mat['event_list'][:5]
    file_list = gt_mat['file_list'][:5]
    print('len_hard_gt_list: ', len(facebox_list))
    print('len_event: ', len(event_list))
    print('len_file_list: ', len(file_list))

    hard_gt_list = hard_mat['gt_list'][:5]  #legend_name 10 1, pr_cruve2 1000
    medium_gt_list = medium_mat['gt_list'][:5]
    easy_gt_list = easy_mat['gt_list'][:5]
    print('len_hard_gt_list: ', len(hard_gt_list))
    print('len_medium_gt_list: ', len(medium_gt_list))
    print('len_easy_gt_list: ', len(easy_gt_list))
...
def evaluation(pred, gt_path ,save_result,model_name,iou_thresh=0.5):
    ...
    with open(os.path.join(save_result,'small_widerface_retinaface_val_result.txt'), 'a') as f:
