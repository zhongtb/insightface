...
if __name__ == '__main__':
    ...
    gcv.utils.export_block('mobilenetV3-large_075',net,data_shape=(224,224,3),layout='CHW',preprocess=False)
    print('finish!')
