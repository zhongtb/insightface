...
config.CONTINUE =False#True#False#True
...
network.mnet.BATCH_IMAGES = 8#16
...
network.mnet.pretrained = ''#'model/mobilenetV3-large_075'#'model/mbnv2' #78
...
network.mnet.LAYER_FIX = False#True
...
default.pretrained = 'model/mbnv2'#'model/resnet-152'
...
# default e2e
default.prefix = 'model/efficientnet-b0/efficientnet-b0'
...
default.end_epoch = 120
default.lr_step = '55,68,120'
default.lr = 0.01
