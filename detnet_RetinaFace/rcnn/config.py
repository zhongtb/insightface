...
config = edict()
config.PLATFORM_DEVICES = False#True # use 7x7 first
...
config.RPN_ANCHOR_CFG = RAC_SSH2 #default
...
network.mnet.BATCH_IMAGES = 32#16
...
network.mnet.pretrained_epoch = 0#79#0
#network.mnet.begin_epoch = 79#0
network.mnet.max_feat_channel = 8888
network.mnet.COLOR_MODE = 1
network.mnet.USE_CROP = True
network.mnet.RPN_ANCHOR_CFG = RAC_SSH2
...
network.resnet.BATCH_IMAGES = 4#8
network.resnet.HEAD_FILTER_NUM = 256
network.resnet.CONTEXT_FILTER_RATIO = 1

network.resnet.USE_DCN = 0
network.resnet.pretrained = 'model/detnet_coco'
network.resnet.RPN_ANCHOR_CFG = DETNET#RAC_SSH
...
default.pretrained = 'model/mobilenet_0_25'#'model/resnet-152'
...
# default e2e
#default.prefix = 'model/mnet_net3a_maxout2/mnet_net3a_maxout2'
#default.prefix = 'model/mnet_net3a_maxout1/mnet_net3a_maxout1'
default.prefix = 'model/detnet/detnet'
#default.prefix = 'model/mnet_net3a_share/mnet_net3a_share'
#default.prefix = 'model/mnet_net3a_7x7/mnet_net3a_7x7'
default.end_epoch = 100#150#100
default.lr_step = '55,68,80'#'100,120,150'#'55,68,80'
default.lr = 0.01#0.0001
